...
public class PhotonPolarizationMeasurement 
{
    ...
    {
        /* Only one of the experiments should be active. 
        When you remove the comments to activate Experiment1, 
        you must add comments to disable Experiment2. 
        */
       ...
       /*  int trueCount = 0; 
        ...
        {
            PhotonPolarizationMeasurement photon = new PhotonPolarizationMeasurement(30);
            if(photon.measurePolarization(90))
            {
                trueCount++;
            }
            else
